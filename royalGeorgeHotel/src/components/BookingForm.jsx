  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // ✅ Call the parent callback to refresh booking list
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <input
            ...
            className="bg-transparent border border-gray-500 px-4 py-2 rounded"
          />
          <input
            name="lastName"
        ...
        <div className="flex items-center">
          ...
          <label className="text-xs text-gray-300">
            I do not consent to join marketing list.
          </label>
        </div>
        ...
        <div className="text-center">
          <button
            type="submit"
            className="px-8 py-2 bg-white text-black rounded hover:bg-gray-200"
          >
            Submit
          </button>
        </div>
